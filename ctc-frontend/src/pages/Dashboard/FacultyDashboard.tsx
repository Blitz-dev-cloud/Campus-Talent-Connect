...
const FacultyDashboard = () => {
  ...
  const handlePostResearch = async (e) => {
    ...
    try {
      ...
      const normalizedOpp = {
        ...res.data,
        posted_by: res.data.posted_by || res.data.faculty_id || user.id,
      ...
      toast.error("Failed to post research opportunity");
    } finally {
      setIsPosting(false);
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 pb-20 lg:pb-4">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-4 sm:py-6 lg:py-8">
        <div className="mb-6 sm:mb-8">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-green-600 via-emerald-600 to-blue-600 bg-clip-text text-transparent mb-2">
            Faculty Dashboard
          </h1>
          <p className="text-gray-600 text-sm sm:text-base lg:text-lg">
            Guide students through research and academic opportunities
          </p>
        </div>

        {/* Desktop Tabs - Hidden on Mobile */}
        <div className="hidden lg:flex gap-2 mb-6 sm:mb-8 bg-white rounded-xl p-2 shadow-lg border border-gray-100">
          {["profile", "create", "research", "applications"].map((tab) => (
            <button
              key={tab}
              ...
              className={`flex-1 min-w-0 sm:min-w-[120px] px-4 sm:px-6 py-3 font-semibold rounded-lg transition-all text-sm sm:text-base ${
                activeTab === tab
                  ? "bg-gradient-to-r from-green-600 via-emerald-600 to-blue-600 text-white shadow-lg scale-105"
                  ...
                  {profile?._id || profile?.id || isEditing ? (
                      ...
                      <div>
                        ...
                        {isEditing ? (
                          <textarea
                            ...
                            rows={4}
                            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent"
                            placeholder="Share your academic background and research interests..."
                          />
                        ) : (
                          <p className="px-4 py-3 bg-gray-50 rounded-lg">
                            {profile?.bio || "Not set"}
                            ...
                            <div className="flex flex-wrap gap-2">
                              {(editedProfile.skills || []).map(
                                (skill, index) => (
                                  <span
                                    key={index}
                                    className="px-4 py-2 bg-green-100 text-green-700 rounded-lg font-medium flex items-center gap-2"
                                  >
                                    {skill}
                                    <button
                                      type="button"
                      ...
                      {isEditing && (
                        <div className="flex gap-3 pt-4">
                          <button
                            type="button"
                            onClick={saveProfile}
                            className="flex-1 px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                          >
                            Save Changes
                          </button>
                          <button
                    ...
                    <div className="text-center py-12">
                      ...
                      <p className="text-gray-600 mb-4">
                        Complete your profile to start posting research
                        opportunities
                      </p>
                      <button
                        type="button"
                        onClick={() => setIsEditing(true)}
                        className="px-6 py-3 bg-gradient-to-r from-green-600 to-blue-600 text-white rounded-xl font-semibold hover:shadow-lg transition-all"
                      >
                        Create Profile
                      </button>
                    </div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">
                      Share research projects with students
                    </p>
                  </div>
                </div>
                <form onSubmit={handlePostResearch} className="space-y-6">
                  <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                      placeholder="Describe the research project, objectives, and requirements..."
                    />
                  </div>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border-2 border-gray-200 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
                        placeholder="e.g., On-campus, Lab A-101"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  <button
                    type="submit"
                    disabled={isPosting}
                    className="w-full bg-gradient-to-r from-green-600 to-blue-600 text-white font-semibold py-4 rounded-xl hover:shadow-lg transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    {isPosting ? "Posting..." : "Post Research Opportunity"}
                  </button>
                </form>
              </motion.div>
            )}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-white/80">
                        Review and manage applications for your research
                        opportunities
                      </p>
                    </div>
                  </div>
